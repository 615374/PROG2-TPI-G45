...
void menuServicios() {
    ...
    do {
        ...
        cout << "3. Listar Servicios por Tipo" << endl;
        cout << "4. Listar Servicios Inactivos" << endl;

        cout << "\n--- MANTENIMIENTO ---" << endl;
        cout << "5. Modificar Servicio" << endl;
        cout << "6. Dar de Baja Servicio" << endl;
        ...
        if (op == 1) {
            ...
            if (aux.cargar() == true) {
                ...
                cout << "\nCarga cancelada. No se guardo el servicio.\n\n";
            }
            cout << "Presione ENTER para continuar...";
            cin.get();
            system("cls");
            ...
            if (pos == 0) {
                ...
                cout << "No hay servicios activos para mostrar.\n\n";
            }
            cout << "\nPresione ENTER para continuar...";
            cin.ignore(1000, '\n');
            cin.get();
